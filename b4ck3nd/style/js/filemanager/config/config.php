<?php
include $_SERVER['DOCUMENT_ROOT']."/berlian/bootstrap.php";

// ob_end_clean();
// cek_admin_login($_SESSION["user_id"], $_SESSION["user_group"]);
...
$fixed_path_from_filemanager            = array(
											'../../../../media/thumbs/_100x100/',
											'../../../../media/thumbs/_369x252/',
											'../../../../media/thumbs/_219x219/',
											'../../../../media/thumbs/_400x200/',
...
$fixed_image_creation_width             = array(100,369,219,400); //width of image (you can leave empty if you set height)
$fixed_image_creation_height            = array(100,252,219,200); //height of image (you can leave empty if you set width)
/*
#             $option:     0 / exact = defined size;
#                          1 / portrait = keep aspect set height;
#                          2 / landscape = keep aspect set width;
