...
<main role="main" class="body">
  ...
  <section style="background-image: url(<?php echo THEMES?>assets/images/repository/inner-header-bg.jpg)" class="clearfix inner-header img-cover">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h2 class="h1 text-danger m0">Past Event of <?php echo $categoryTitle?></h2>
        </div>
        <div class="col-md-6 text-right">
          <ol class="breadcrumb m0 p0">
            <li><a href="<?php echo BASE?>" class="text-danger">HOME</a></li>
            <li><a href="<?php echo BASE?>event-past" class="text-danger">PAST EVENT</a></li>
            <li><a href="<?php echo BASE.'event-past/'.$category->slug?>" class="text-danger"><?php echo strtoupper($categoryTitle)?></a></li>
