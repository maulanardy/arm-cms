...
if(Io::param('delete')){
	$data = $category->delete(Io::param('id'));
	if($data){
    helper::flashdata('regStatus','<div class="alert alert-success" role="alert">Data berhasil dihapus</div>');
		echo "<script>window.location='index.php?menu=Event&sub=category'</script>";
	}
}
?>
<div class="panel panel-danger">
  ...
  <div class="panel-body">
    ...
    <a href="<?php echo BASE.BACKEND?>/index.php?menu=Event&sub=category" class="btn btn-default">Cancel</a>
